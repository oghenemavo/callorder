        ...
        <li class="dropdown user-dropdown">
            <a href="#" class="dropdown-toggle mr-n1" data-toggle="dropdown">
                <div class="user-toggle">
                    ...
                    <div class="user-info d-none d-xl-block">
                        <div class="user-status user-status-active">{{ ucwords(auth()->user()->roles()->first()->name) }}</div>
            ...
            <div class="dropdown-menu dropdown-menu-md dropdown-menu-right">
                <div class="dropdown-inner user-card-wrap bg-lighter d-none d-md-block">
                    <div class="user-card">
                        <div class="user-avatar">
                            <span>{{ strtoupper(auth()->user()->initials) }}</span>
                        </div>
                        <div class="user-info">
                            <span class="lead-text">{{ ucwords(auth()->user()->name) }}</span>
                            <span class="sub-text">{{ ucwords(auth()->user()->email) }}</span>
                        </div>
                    </div>
                </div>
